...
const setup_crew_monitoring_1 = require("./setup-crew-monitoring");
const getDb = () => {
...
const ensureDatabase = () => {
  ...
  `);
    ...
    (0, setup_crew_monitoring_1.ensureCrewMonitoringDatabase)();
    (0, setup_crew_monitoring_1.seedCrewData)();
